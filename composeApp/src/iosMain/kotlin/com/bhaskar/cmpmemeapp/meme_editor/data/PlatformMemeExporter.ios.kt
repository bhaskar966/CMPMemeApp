...
import com.bhaskar.cmpmemeapp.meme_editor.presentation.utils.MemeRenderCalculator
import com.bhaskar.cmpmemeapp.meme_editor.presentation.utils.ScaledMemeText
...
actual class PlatformMemeExporter : MemeExporter {
    ...
    val memeRenderCalculator = MemeRenderCalculator(
    ...
    private fun drawText(context: CGContextRef, memeText: ScaledMemeText) {
        ...
        val attributes = createMemeTextAttributes(
            ...
            strokeSize = memeText.strokeWidth
        )
    ...
    private fun createMemeTextAttributes(
        ...
        return mapOf(
            ...
            NSStrokeWidthAttributeName to NSNumber(-strokeSize),
